      ...
      if (this.exploded && this.particles.length === 0) {
        ...
        for(let i = 0; i < this.textAsPoints.length; i++){
          this.scatteredPoints.push({
            ...
            targetx: this.textAsPoints[i].x, // Target x position for the text point
            targety: this.textAsPoints[i].y  // Target y position for the text point
          })
        }
  ...
  show() {
    if (this.state == "explosion") {
      ...
      for (var i = 0; i < this.particles.length; i++) {
        this.particles[i].show(); // Display each particle
      }
    }
    else if (this.state == "formation") {
